(() => {
  ...
  function EditModal({ todo, onSave, onClose }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { position: "fixed", inset: 0, background: "rgba(0,0,0,.45)", display: "flex", alignItems: "flex-end", justifyContent: "center", zIndex: 2e3 }, onClick: onClose }, /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, background: "#fff", borderRadius: "20px 20px 0 0", padding: "24px 20px", paddingBottom: "calc(28px + env(safe-area-inset-bottom))", width: "100%", maxWidth: 520, maxHeight: "92dvh", overflowY: "auto", boxShadow: "0 -4px 24px rgba(0,0,0,.12)" }, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { style: { width: 40, height: 4, background: "#ddd", borderRadius: 2, margin: "0 auto 20px" } }), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: PINK, marginBottom: 14 } }, (todo == null ? void 0 : todo.id) ? "タスクを編集" : "新しいタスク"), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        value: text,
  ...
  function TodoCard({ todo, isDone, isAm, sortIdx, colId, onEdit, onDelete, onToggle, sortDrag }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "flex-start", gap: 8 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3, padding: "3px 4px", cursor: "grab", flexShrink: 0, marginTop: 2 } }, [0, 1, 2].map((i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", gap: 2 } }, [0, 1].map((j) => /* @__PURE__ */ React.createElement("div", { key: j, style: { width: 3, height: 3, borderRadius: "50%", background: imp && !isDone ? "#F09595" : "#ccc" } }))))), /* @__PURE__ */ React.createElement("button", { "aria-label": isDone ? "未完了に戻す" : "完了にする", onClick: (e) => {
        e.stopPropagation();
        onToggle(todo.id);
      }, style: { width: 26, height: 26, minWidth: 26, borderRadius: 7, marginTop: 0, border: `2px solid ${isDone ? ac : imp ? "#F09595" : "#bbb"}`, background: isDone ? ac : "#fff", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, padding: 0 } }, isDone && /* @__PURE__ */ React.createElement("span", { style: { color: "#fff", fontSize: 14, fontWeight: 700, lineHeight: 1 } }, "✓")), /* @__PURE__ */ React.createElement("div", { onClick: () => onEdit(todo), style: { flex: 1, minWidth: 0, cursor: "pointer", padding: "2px 0 4px" } }, /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, fontSize: imp && !isDone ? 14 : 13, fontWeight: imp && !isDone ? 700 : 500, color: isDone ? "#aaa" : imp ? IMP_RED_TEXT : "#111", textDecoration: isDone ? "line-through" : "none", lineHeight: 1.5, wordBreak: "break-word" } }, todo.text), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", marginTop: imp || lbl ? 4 : 0 } }, imp && !isDone && /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 10, fontWeight: 700, color: IMP_RED_TEXT, background: "#F7C1C1", borderRadius: 99, padding: "2px 8px" } }, "‼️ 重要"), lbl && /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 10, fontWeight: 700, color: ct, background: cb, borderRadius: 4, padding: "2px 8px" } }, "🔁 ", lbl))), /* @__PURE__ */ React.createElement("div", { style: { position: "relative", flexShrink: 0 } }, /* @__PURE__ */ React.createElement("button", { "aria-label": "タスクメニュー", onClick: (e) => {
        e.stopPropagation();
        setShowMenu((p) => !p);
      }, style: { width: 36, height: 36, background: "transparent", border: "none", borderRadius: 8, color: "#888", cursor: "pointer", fontSize: 20, lineHeight: 1 } }, "⋯"), showMenu && /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", right: 0, top: 38, zIndex: 20, width: 138, background: "#fff", border: "1px solid #ddd", borderRadius: 10, padding: 5, boxShadow: "0 8px 24px rgba(0,0,0,.16)" }, onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
        setShowMenu(false);
        onEdit(todo);
      }, style: { ...FONT_STYLE, width: "100%", padding: "10px 12px", textAlign: "left", background: "none", border: "none", borderRadius: 7, fontSize: 13, color: "#444", cursor: "pointer" } }, "✏️ 編集"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
        setShowMenu(false);
        onDelete(todo.id);
      }, style: { ...FONT_STYLE, width: "100%", padding: "10px 12px", textAlign: "left", background: "#fff2f2", border: "none", borderRadius: 7, fontSize: 13, color: "#c33", cursor: "pointer" } }, "🗑 削除"))))
    );
  }
  ...
  function SlotColumn({ colId, isAm, todos, doneIds, onEdit, onDelete, onToggle, onAdd, sortDrag }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: isAm ? AM_HEAD : PM_HEAD, marginBottom: 8 } }, isAm ? "🌱 AM" : "☀️ PM"),
      sorted.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, fontSize: 10, color: "#ccc", textAlign: "center", padding: "14px 0", fontStyle: "italic" } }, "タスクなし"),
      ...
      /* @__PURE__ */ React.createElement("button", { onClick: () => onAdd(colId), style: { ...FONT_STYLE, marginTop: 6, width: "100%", minHeight: 42, padding: "8px", background: "transparent", border: `1.5px dashed ${isAm ? AM_BORDER : PM_BORDER}`, borderRadius: 9, color: isAm ? AM_TEXT : PM_TEXT, cursor: "pointer", fontSize: 11, fontWeight: 700 } }, "＋ タスクを追加")
    );
  }
  function DayColumn({ dayIndex, date, amTodos, pmTodos, accent, isToday, hideHeader = false, doneIds, onEdit, onDelete, onToggle, onAdd, sortDrag }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, background: "#fff", border: hideHeader ? "1px solid #e5e5e5" : `${isToday ? "2px" : "1.5px"} solid ${isToday ? PINK : "#e2e2e2"}`, borderRadius: 14, padding: hideHeader ? "10px" : "14px 12px", boxShadow: hideHeader ? "none" : isToday ? `0 0 0 3px ${PINK_LIGHT}` : "0 1px 4px rgba(0,0,0,.06)" } }, !hideHeader && /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 4 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 3, height: 16, background: accent, borderRadius: 2 } }), /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 13, fontWeight: isToday ? 700 : 400, color: isToday ? PINK : "#111" } }, getDayLabel(dayIndex, date))), /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, fontSize: 15, fontWeight: 700, color: isToday ? PINK : "#111", marginTop: 3, marginLeft: 9 } }, fmtDate(date), "（", DAYS_JP[date.getDay()], "）")), !hideHeader && /* @__PURE__ */ React.createElement(VolumeBar, { amCount: amTodos.length, pmCount: pmTodos.length }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 8 } }, /* @__PURE__ */ React.createElement(SlotColumn, { colId: amId, isAm: true, todos: amTodos, ...slotProps }), /* @__PURE__ */ React.createElement(SlotColumn, { colId: pmId, isAm: false, todos: pmTodos, ...slotProps })));
  }
  function MobileDaySection({ defaultOpen = false, dayIndex, date, amTodos, pmTodos, isToday, accent, ...props }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOpen((p) => !p), style: { ...FONT_STYLE, width: "100%", minHeight: 58, display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", background: isToday ? PINK_LIGHT : "#fff", border: `${isToday ? 2 : 1.5}px solid ${isToday ? PINK : "#e2e2e2"}`, borderRadius: open ? "14px 14px 8px 8px" : 14, boxShadow: "0 1px 4px rgba(0,0,0,.05)", cursor: "pointer", textAlign: "left" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 4, height: 26, background: isToday ? PINK : accent, borderRadius: 3, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 13, fontWeight: 700, color: isToday ? PINK : "#222" } }, getDayLabel(dayIndex, date), " ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500, color: "#888" } }, fmtDate(date), "（", DAYS_JP[date.getDay()], "）")), /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 10, color: "#999", marginTop: 2 } }, "🌱 ", amTodos.length, "件　☀️ ", pmTodos.length, "件", done > 0 ? `　✓ ${done}/${total}` : "")), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, color: "#999", transform: open ? "rotate(90deg)" : "none", transition: "transform .15s" } }, "›")), open && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, /* @__PURE__ */ React.createElement(DayColumn, { dayIndex, date, amTodos, pmTodos, accent, isToday, hideHeader: true, ...props })));
  }
  function InboxPage({ todos, doneIds, onEdit, onDelete, onToggle, onAdd, sortDrag, onQuickAdd, dateCols }) {
    const sorted = useMemo(() => [...todos].sort((a, b) => (b.important ? 1 : 0) - (a.important ? 1 : 0)), [todos]);
    return /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, maxWidth: 640, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 14 } }, /* @__PURE__ */ React.createElement(QuickEntry, { onAdd: onQuickAdd, dateCols })), /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, background: "#fff", border: "1.5px solid #e2e2e2", borderRadius: 14, padding: "16px 14px", boxShadow: "0 1px 4px rgba(0,0,0,.06)" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 12 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 3, height: 16, background: PINK, borderRadius: 2 } }), /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 13, fontWeight: 700, color: "#111" } }, "ストック"), /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 10, color: "#aaa", marginLeft: 4 } }, "とりあえずためておく場所")), /* @__PURE__ */ React.createElement("div", { style: { height: 1, background: "#f0f0f0", marginBottom: 12 } }), sorted.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, fontSize: 12, color: "#ccc", textAlign: "center", padding: "24px 0" } }, "タスクがありません"), sorted.map((t, i) => /* @__PURE__ */ React.createElement(TodoCard, { key: t.id, todo: t, sortIdx: i, colId: "inbox", isDone: doneIds.has(t.id), isAm: false, onEdit: (todo) => onEdit(todo, "inbox"), onDelete, onToggle, sortDrag })), /* @__PURE__ */ React.createElement("button", { onClick: onAdd, style: { ...FONT_STYLE, marginTop: 8, width: "100%", padding: "8px", background: "transparent", border: "1.5px dashed #ccc", borderRadius: 8, color: "#aaa", fontSize: 12, fontWeight: 700, cursor: "pointer" } }, "＋ 追加")));
  }
  const HINT_CHIPS = [
  ...
  function QuickEntry({ onAdd, dateCols }) {
    ...
    if (isMobile && !expanded) return /* @__PURE__ */ React.createElement("button", { onClick: () => setExpanded(true), style: { ...FONT_STYLE, width: "100%", minHeight: 52, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 16px", marginBottom: 12, background: "#0d0d0d", color: "#fff", border: "none", borderRadius: 13, fontSize: 13, fontWeight: 700, cursor: "pointer", boxShadow: "0 3px 10px rgba(0,0,0,.12)" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 20, lineHeight: 1 } }, "＋"), " タスクを追加");
    return /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, background: "#fff", border: `1.5px solid ${focused ? PINK : "#d8d8d8"}`, borderRadius: 12, padding: window.innerWidth < 720 ? "10px 12px" : "14px 16px", marginBottom: 12, boxShadow: focused ? `0 0 0 3px ${PINK_LIGHT}` : "0 1px 3px rgba(0,0,0,.06)", boxSizing: "border-box", width: "100%", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, fontWeight: 700, color: PINK } }, "＋ タスクを追加"), !isMobile && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#bbb", marginLeft: "auto" } }, "⌘Enter"), isMobile && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setExpanded(false);
      setText("");
    }, "aria-label": "入力を閉じる", style: { marginLeft: "auto", width: 32, height: 32, border: "none", borderRadius: 8, background: "#f3f3f3", color: "#888", fontSize: 18, cursor: "pointer" } }, "×")), /* @__PURE__ */ React.createElement(
      "textarea",
      {
        ref: textareaRef,
        value: text,
  ...
  function App() {
    ...
    const boardContent = (() => {
      ...
      if (isReadOnly) {
        if (layout === "stack") {
          return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 12, overflowY: "auto", WebkitOverflowScrolling: "touch", flex: 1, padding: "0 12px calc(96px + env(safe-area-inset-bottom))" } }, cols.map((date, i) => /* @__PURE__ */ React.createElement("div", { key: i, style: { ...FONT_STYLE, background: "#fff", border: "1.5px solid #e8e8e8", borderRadius: 14, padding: "12px", opacity: 0.88 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: "#888", marginBottom: 8 } }, fmtDate(date), "（", DAYS_JP[date.getDay()], "）"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, /* @__PURE__ */ React.createElement(ReadonlySlot, { isAm: true, todos: am[i], doneIds }), /* @__PURE__ */ React.createElement(ReadonlySlot, { isAm: false, todos: pm[i], doneIds })))));
        }
      ...
      if (layout === "stack") {
        return /* @__PURE__ */ React.createElement("div", { style: { overflowY: "auto", WebkitOverflowScrolling: "touch", flex: 1, padding: "0 10px calc(96px + env(safe-area-inset-bottom))", boxSizing: "border-box" } }, boardWeek === 0 && /* @__PURE__ */ React.createElement(QuickEntry, { onAdd: handleQuickAdd, dateCols: cols }), boardWeek !== 0 && /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 6px", fontSize: 11, color: "#aaa" } }, isReadOnly ? "👁 閲覧のみ — 過去の記録" : ""), cols.map((date, i) => /* @__PURE__ */ React.createElement("div", { key: `${boardWeek}-${i}`, id: boardWeek === 0 && isToday(date) ? "day-col-0-today-stack" : void 0 }, /* @__PURE__ */ React.createElement(MobileDaySection, { defaultOpen: boardWeek === 0 ? isToday(date) : i === 0, dayIndex: i, date, accent: isToday(date) ? PINK : colAccents[i], amTodos: am[i], pmTodos: pm[i], ...sp, onEdit: (t, c) => handleEdit(t, c), isToday: isToday(date) }))));
      }
    ...
    }), (boardWeek === -1 || boardWeek === -2) && /* @__PURE__ */ React.createElement("span", { style: { ...FONT_STYLE, fontSize: 11, color: "#aaa", alignSelf: "center" } }, "👁 閲覧のみ")), tab === "guide" ? /* @__PURE__ */ React.createElement("div", { style: { flex: layout === "stack" ? 1 : "unset", overflowY: layout === "stack" ? "auto" : "visible", padding: layout === "stack" ? "0 12px calc(96px + env(safe-area-inset-bottom))" : "0" } }, /* @__PURE__ */ React.createElement(QuickGuide, null)) : tab === "trash" ? /* @__PURE__ */ React.createElement("div", { style: { flex: layout === "stack" ? 1 : "unset", overflowY: layout === "stack" ? "auto" : "visible", padding: layout === "stack" ? "0 12px calc(96px + env(safe-area-inset-bottom))" : "0" } }, /* @__PURE__ */ React.createElement(TrashBin, { trash, onRestore: handleRestore, onPermanentDelete: (id) => setTrash((p) => p.filter((t) => t.id !== id)), onClearAll: () => setTrash([]) })) : tab === "routines" ? /* @__PURE__ */ React.createElement("div", { style: { flex: layout === "stack" ? 1 : "unset", overflowY: layout === "stack" ? "auto" : "visible", padding: layout === "stack" ? "0 12px calc(96px + env(safe-area-inset-bottom))" : "0" } }, /* @__PURE__ */ React.createElement(RoutineManager, { routines, onAdd: handleAddRoutine, onUpdate: handleUpdateRoutine, onDelete: handleDeleteRoutine, onToggle: handleToggleRoutine })) : tab === "inbox" ? /* @__PURE__ */ React.createElement("div", { style: { flex: layout === "stack" ? 1 : "unset", overflowY: layout === "stack" ? "auto" : "visible", padding: layout === "stack" ? "0 12px calc(96px + env(safe-area-inset-bottom))" : "0" } }, /* @__PURE__ */ React.createElement(InboxPage, { todos: inbox, ...sp, onAdd: () => handleAdd("inbox"), onQuickAdd: handleQuickAdd, dateCols })) : boardContent, layout === "stack" && /* @__PURE__ */ React.createElement("nav", { "aria-label": "メインナビゲーション", style: { position: "fixed", left: 0, right: 0, bottom: 0, zIndex: 1500, display: "grid", gridTemplateColumns: "repeat(5,1fr)", background: "rgba(255,255,255,.96)", borderTop: "1px solid #ddd", boxShadow: "0 -4px 18px rgba(0,0,0,.08)", padding: "6px 6px calc(6px + env(safe-area-inset-bottom))", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" } }, [["board", "📋", "ボード"], ["inbox", "📥", "ストック"], ["routines", "🔁", "ルーティン"], ["trash", "🗑", "ゴミ箱"], ["guide", "📖", "使い方"]].map(([key, icon, label]) => /* @__PURE__ */ React.createElement("button", { key, onClick: () => setTab(key), style: { ...FONT_STYLE, position: "relative", minHeight: 52, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 2, background: "transparent", border: "none", borderRadius: 10, color: tab === key ? PINK : "#777", fontSize: 9, fontWeight: tab === key ? 700 : 500, cursor: "pointer" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 19, lineHeight: 1 } }, icon), /* @__PURE__ */ React.createElement("span", null, label), key === "inbox" && inbox.length > 0 && badge(inbox.length, PINK), key === "trash" && trash.length > 0 && badge(trash.length, "#888")))), layout !== "stack" && /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, marginTop: 14, fontSize: 11, color: "#bbb" } }, "💡 ✏️ 編集から重要マーク設定、ドラッグハンドルで並び替えができます"), showModal && editTodo && /* @__PURE__ */ React.createElement(EditModal, { todo: editTodo.todo, onSave: handleSave, onClose: () => {
      setShowModal(false);
      setEditTodo(null);
    } }));
  }
