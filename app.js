(() => {
  ...
  function SlotColumn({ colId, isAm, todos, doneIds, onEdit, onDelete, onToggle, onAdd, sortDrag }) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("button", { onClick: () => onAdd(colId), style: { ...FONT_STYLE, marginTop: 6, width: "100%", minHeight: 42, padding: "8px", background: "transparent", border: `1.5px dashed ${isAm ? AM_BORDER : PM_BORDER}`, borderRadius: 9, color: isAm ? AM_TEXT : PM_TEXT, cursor: "pointer", fontSize: 12, fontWeight: 700 } }, "＋ タスクを追加")
    );
  }
  ...
  function MobileDaySection({ defaultOpen = false, dayIndex, date, amTodos, pmTodos, isToday, accent, ...props }) {
    ...
    return /* @__PURE__ */ React.createElement("section", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("button", { onClick: () => setOpen((p) => !p), style: { ...FONT_STYLE, width: "100%", minHeight: 58, display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", background: isToday ? PINK_LIGHT : "#fff", border: `${isToday ? 2 : 1.5}px solid ${isToday ? PINK : "#e2e2e2"}`, borderRadius: open ? "14px 14px 8px 8px" : 14, boxShadow: "0 1px 4px rgba(0,0,0,.05)", cursor: "pointer", textAlign: "left" } }, /* @__PURE__ */ React.createElement("span", { style: { width: 4, height: 26, background: isToday ? PINK : accent, borderRadius: 3, flexShrink: 0 } }), /* @__PURE__ */ React.createElement("span", { style: { flex: 1, minWidth: 0 } }, /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 14, fontWeight: 700, color: isToday ? PINK : "#222" } }, getDayLabel(dayIndex, date), " ", /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 500, color: "#888" } }, fmtDate(date), "（", DAYS_JP[date.getDay()], "）")), /* @__PURE__ */ React.createElement("span", { style: { display: "block", fontSize: 11, color: "#999", marginTop: 2 } }, "🌱 ", amTodos.length, "件　☀️ ", pmTodos.length, "件", done > 0 ? `　✓ ${done}/${total}` : "")), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 18, color: "#999", transform: open ? "rotate(90deg)" : "none", transition: "transform .15s" } }, "›")), open && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 6 } }, /* @__PURE__ */ React.createElement(DayColumn, { dayIndex, date, amTodos, pmTodos, accent, isToday, hideHeader: true, ...props })));
  }
  ...
  function QuickEntry({ onAdd, dateCols }) {
    ...
    if (isMobile && !expanded) return /* @__PURE__ */ React.createElement("button", { onClick: () => setExpanded(true), style: { ...FONT_STYLE, width: "100%", minHeight: 52, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "12px 16px", marginBottom: 12, background: "#0d0d0d", color: "#fff", border: "none", borderRadius: 13, fontSize: 14, fontWeight: 700, cursor: "pointer", boxShadow: "0 3px 10px rgba(0,0,0,.12)" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 20, lineHeight: 1 } }, "＋"), " タスクを追加");
    return /* @__PURE__ */ React.createElement("div", { style: { ...FONT_STYLE, background: "#fff", border: `1.5px solid ${focused ? PINK : "#d8d8d8"}`, borderRadius: 12, padding: window.innerWidth < 720 ? "10px 12px" : "14px 16px", marginBottom: 12, boxShadow: focused ? `0 0 0 3px ${PINK_LIGHT}` : "0 1px 3px rgba(0,0,0,.06)", boxSizing: "border-box", width: "100%", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: PINK } }, "＋ タスクを追加"), !isMobile && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, color: "#bbb", marginLeft: "auto" } }, "⌘Enter"), isMobile && /* @__PURE__ */ React.createElement("button", { onClick: () => {
      setExpanded(false);
      setText("");
